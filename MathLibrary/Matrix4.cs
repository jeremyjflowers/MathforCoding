...
namespace MathLibrary
{
    public class Matrix4
    {
        ...
        /// <summary>
        /// Creates a new matrix that has been rotated by the given value on the X-axis
        /// </summary>
        ...
        /// <summary>
        /// Creates a new matrix that has been rotated by the given value on the Y-axis
        /// </summary>
        /// <param name="radians"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a new matrix that has been rotated by the given value on the Z-axis
        /// </summary>
        /// <param name="radians"></param>
        /// <returns></returns>
